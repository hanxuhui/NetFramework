...
public class StatusBarUtil {
    ...
    // 透明且背景不占用控件的 statusbar，这里估且叫做沉浸
    ...
    private StatusBarUtil(Window window, boolean lightStatusBar, boolean transparentStatusBar, View actionBarView) {
    ...
    final public static class Builder {
        ...
        public Builder setTransparentStatusbar() {
